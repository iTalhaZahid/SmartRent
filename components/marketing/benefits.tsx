...
const benefits = [
  {
    ...
    text: "Every listing is reviewed, with clear pricing and verified property details.",
  },
  {
    icon: Sparkles,
    title: "A smoother search",
    text: "Smart filters and honest information help you shortlist the right place faster.",
  },
  {
    icon: Headphones,
    title: "Support that stays",
    text: "From your first viewing to move-in day, real help is always within reach.",
  },
];
        ...
        <div className="mt-14 grid gap-5 md:grid-cols-3">
          {benefits.map(({icon: Icon, title, text}) => (
            <Card key={title} className="group rounded-2xl border-slate-200 bg-white shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl">
              <CardHeader>
                <span className="mb-4 grid size-12 place-items-center rounded-2xl bg-teal-50 text-primary transition-colors group-hover:bg-primary group-hover:text-white">
